...
class InCompletedProjectTable extends StatefulWidget {
  var listdata;
  String listTitle;
  String ssoNumber;
  String token;
  String days;
  InCompletedProjectTable(
      {Key? key,
  ...
  @override
  State<InCompletedProjectTable> createState() =>
      _InCompletedProjectTableState(listdata);
}

class _InCompletedProjectTableState extends State<InCompletedProjectTable> {
  var listdata;

  var tableRow;

  _InCompletedProjectTableState(this.listdata);
